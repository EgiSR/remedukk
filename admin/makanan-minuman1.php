                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="makanan-minuman.php?op=edit&id_masakan=<?= $data_masakan['id_masakan'] ?>" class="btn btn-warning ">Edit</a>
                                                <a href="makanan-minuman.php?op=delete&id_masakan=<?= $data_masakan['id_masakan'] ?>" onclick="return confirm('Yakin ingin menghapus data ini?')" class="btn btn-danger ">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
